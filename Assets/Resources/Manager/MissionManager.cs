...
public class MissionManager : MonoBehaviour, InteractableObject
{
    ...
    private MissionItemUIManager missionItemUIManager;
    ...
    void Start()
    {
        ...
        missionItemUIManager = FindAnyObjectByType<MissionItemUIManager>();
    ...
    public void UpdateMissions()
    {
        ...
        this.missionItemUIManager.GenerateMissionItemUI();
    }
